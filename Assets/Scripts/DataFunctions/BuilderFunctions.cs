...
namespace JBK.AstrocyteViewer.DataFunctions
{
    public static class BuilderFunctions 
    {
        ...
        public static GameObject FVmesh(Vector3[] vertices, int[] faces)
        {
            ...
            var meshInstance = new GameObject();
        ...
        {
            var meshInstance = FVmesh(vertices, faces);
        ...
        {
            var scatterContainer = new GameObject("scatter3Container");
            ...
            {
                var nsp = GameObject.Instantiate(sp); 
